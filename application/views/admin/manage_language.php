		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                        ...
                        <input type="submit" value="<?php echo ('Update Phrase');?>" onClick="document.getElementById('phrase_form').submit();" class="btn btn-primary"/>	
                    	...
                    	<tr>
                        	...
                        	<td>
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_language/edit_phrase/<?php echo $field;?>"
                                	...
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit Phrase');?>" class="btn btn-primary">
                    ...
                    <?php echo form_open('admin/manage_language/add_phrase/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo ('Phrase');?></label>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary"><?php echo ('Add Phrase');?></button>
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_language/add_language/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary"><?php echo ('Add Language');?></button>
