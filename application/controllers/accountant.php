...

{
...

	{
		...
		if ($param1 == 'create') {
			...
			$this->session->set_flashdata('flash_message', ('Invoice Created'));
		...
		if ($param1 == 'edit' && $param2 == 'do_update') {
			...
			$this->session->set_flashdata('flash_message', ('Invoice Updated'));
		...
		if ($param1 == 'delete') {
			...
			$this->session->set_flashdata('flash_message', ('Invoice Deleted'));
...

	{
		...
		$this->session->set_flashdata('flash_message', ('Payment Created'));
